            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="start_date"
                            {...register('start_date')}
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors ${errors.start_date
                                    ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="due_date"
                            {...register('due_date')}
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors ${errors.due_date
                                    ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            id="status"
                            {...register('status')}
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors ${errors.status
                                    ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                    ...
                    <div>
                        ...
                        <select
                            id="priority"
                            {...register('priority')}
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors ${errors.priority
                                    ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors resize-none ${errors.description
                                ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors ${errors.assignee_id
                                ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                ...
                <div className="flex justify-end space-x-4">
                    <button
                        ...
                        className={`px-6 py-2 rounded-md font-medium transition-colors ${isSubmitting || !isValid
